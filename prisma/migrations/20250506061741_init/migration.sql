...
CREATE TABLE `EventSeries` (
    ...
    `durationType` ENUM('fixed', 'percentage', 'random_uniform', 'random_normal') NOT NULL,
...
CREATE TABLE `AssetType` (
    ...
    `returnAmtOrPct` ENUM('amount', 'percent') NOT NULL,
...
CREATE TABLE `Scenario` (
    ...
    `inflationAssumption` ENUM('fixed', 'percentage', 'random_uniform', 'random_normal') NOT NULL,
    `inflation` DOUBLE NULL,
    `inflationMin` DOUBLE NULL,
    `inflationMax` DOUBLE NULL,
