...
CREATE TABLE `Scenario` (
    ...
    `userLifeExpectancyMean` INTEGER NOT NULL,
    `userLifeExpectancyStd` DOUBLE NOT NULL,
    ...
    `preTaxRetirementContributionLimit` INTEGER NOT NULL,
    `afterTaxRetirementContributionLimit` INTEGER NOT NULL,
