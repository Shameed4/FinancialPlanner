                            ...
                            <div className="w-full max-w-md">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="appearance-none bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm shadow-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2.5 pr-10 transition-all rounded-md"
                                    >
